...
ALTER TABLE llx_invoicegenerator_invoicegeneratortemplate ADD INDEX idx_invoicegenerator_invoicegeneratortemplate_fk_soc (fk_soc);
ALTER TABLE llx_invoicegenerator_invoicegeneratortemplate ADD INDEX idx_invoicegenerator_invoicegeneratortemplate_fk_project (fk_project);
