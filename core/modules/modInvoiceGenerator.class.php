...
/**
 * 	\defgroup   invoicegenerator     Module InvoiceGenerator
 *  \brief      InvoiceGenerator module descriptor.
 *
 *  \file       htdocs/invoicegenerator/core/modules/modInvoiceGenerator.class.php
 *  \ingroup    invoicegenerator
 *  \brief      Description and activation file for module InvoiceGenerator
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module InvoiceGenerator
 */
class modInvoiceGenerator extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 136001; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'invoicegenerator';
		...
		// Module label (no space allowed), used if translation string 'ModuleInvoiceGeneratorName' not found (InvoiceGenerator is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleInvoiceGeneratorDesc' not found (InvoiceGenerator is name of module).
		$this->description = "InvoiceGeneratorDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "InvoiceGeneratorDescription";

		// Author
		$this->editor_name = 'MONA.RE';
		$this->editor_url = '';
		...
		// Key used in llx_const table to save module status enabled/disabled (where INVOICEGENERATOR is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/invoicegenerator/css/invoicegenerator.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/invoicegenerator/js/invoicegenerator.js.php',
			),
		...
		// Example: this->dirs = array("/invoicegenerator/temp","/invoicegenerator/subdir");
		$this->dirs = array("/invoicegenerator/temp");

		// Config pages. Put here list of php page, stored into invoicegenerator/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@invoicegenerator");
		...
		$this->langfiles = array("invoicegenerator@invoicegenerator");
		...
		//$this->automatic_activation = array('FR'=>'InvoiceGeneratorWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('INVOICEGENERATOR_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('INVOICEGENERATOR_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->invoicegenerator) || !isset($conf->invoicegenerator->enabled)) {
			$conf->invoicegenerator = new stdClass();
			$conf->invoicegenerator->enabled = 0;
		}

		// Array to add new pages in new tabs
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@invoicegenerator:$user->rights->invoicegenerator->read:/invoicegenerator/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@invoicegenerator:$user->rights->othermodule->read:/invoicegenerator/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array(isModEnabled('invoicegenerator'), isModEnabled('invoicegenerator'), isModEnabled('invoicegenerator')),
		...
		*/
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in invoicegenerator/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'invoicegeneratorwidget1.php@invoicegenerator',
			//      'note' => 'Widget provided by InvoiceGenerator',
		...
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("invoicegenerator")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("invoicegenerator")', 'priority'=>50)
		// );
		...
		$this->menu[$r++] = array(
			...
			'titre'=>'ModuleInvoiceGeneratorName',
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'invoicegenerator');
		$result = $this->_load_tables('/invoicegenerator/sql/');
		if ($result < 0) {
		...
		$result = $extrafields->addExtraField('invoicegeneratortemplateid', "invoicegenerator templateid label", 'boolean', 1, 1, 'thirdparty');
		...
		//$result4=$extrafields->addExtraField('invoicegenerator_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'invoicegenerator@invoicegenerator', 'isModEnabled("invoicegenerator")');
		//$result5=$extrafields->addExtraField('invoicegenerator_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'invoicegenerator@invoicegenerator', 'isModEnabled("invoicegenerator")');
