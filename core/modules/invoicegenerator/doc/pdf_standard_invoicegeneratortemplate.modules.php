...
/**
 *	Class to manage PDF template standard_invoicegeneratortemplate
 */
class pdf_standard_invoicegeneratortemplate extends ModelePDFInvoiceGeneratorTemplate
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->invoicegenerator->dir_output.'/invoicegeneratortemplate') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->invoicegenerator->dir_output.'/invoicegeneratortemplate';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->invoicegenerator->dir_output.'/invoicegeneratortemplate/'.$objectref;
