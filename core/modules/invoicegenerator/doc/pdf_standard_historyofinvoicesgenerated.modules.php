...
/**
 *  \file       core/modules/invoicegenerator/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_historyofinvoicesgenerated
 */
class pdf_standard_historyofinvoicesgenerated extends ModelePDFHistoryOfInvoicesGenerated
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->invoicegenerator->dir_output.'/historyofinvoicesgenerated') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->invoicegenerator->dir_output.'/historyofinvoicesgenerated';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->invoicegenerator->dir_output.'/historyofinvoicesgenerated/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('INVOICEGENERATOR_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('INVOICEGENERATOR_DRAFT_WATERMARK')));
		}
