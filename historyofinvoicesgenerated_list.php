...
/**
 *   	\file       historyofinvoicesgenerated_list.php
 *		\ingroup    invoicegenerator
 *		\brief      List page for historyofinvoicesgenerated
 */
...
require_once __DIR__.'/class/historyofinvoicesgenerated.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('invoicegenerator', 'historyofinvoicesgenerated', 'write');
	$permissiontodelete = $user->hasRight('invoicegenerator', 'historyofinvoicesgenerated', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (!isModEnabled("invoicegenerator")) {
	accessforbidden('Module invoicegenerator not enabled');
}
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'HistoryOfInvoicesGenerated';
	$objectlabel = 'HistoryOfInvoicesGenerated';
	$uploaddir = $conf->invoicegenerator->dir_output;
...
$title = $langs->trans("HistoryOfInvoicesGenerateds");
//$help_url = "EN:Module_HistoryOfInvoicesGenerated|FR:Module_HistoryOfInvoicesGenerated_FR|ES:Módulo_HistoryOfInvoicesGenerated";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/invoicegenerator/historyofinvoicesgenerated_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/invoicegenerator/historyofinvoicesgenerated_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendHistoryOfInvoicesGeneratedRef";
$modelmail = "historyofinvoicesgenerated";
$objecttmp = new HistoryOfInvoicesGenerated($db);
