...
/**
 *   	\file       invoicegeneratortemplate_list.php
 *		\ingroup    invoicegenerator
 *		\brief      List page for invoicegeneratortemplate
 */
...
require_once __DIR__.'/class/invoicegeneratortemplate.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('invoicegenerator', 'invoicegeneratortemplate', 'write');
	$permissiontodelete = $user->hasRight('invoicegenerator', 'invoicegeneratortemplate', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'InvoiceGeneratorTemplate';
	$objectlabel = 'InvoiceGeneratorTemplate';
...
$title = $langs->trans("InvoiceGeneratorTemplates");
//$help_url = "EN:Module_InvoiceGeneratorTemplate|FR:Module_InvoiceGeneratorTemplate_FR|ES:Módulo_InvoiceGeneratorTemplate";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/invoicegenerator/invoicegeneratortemplate_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/invoicegenerator/invoicegeneratortemplate_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendInvoiceGeneratorTemplateRef";
$modelmail = "invoicegeneratortemplate";
$objecttmp = new InvoiceGeneratorTemplate($db);
