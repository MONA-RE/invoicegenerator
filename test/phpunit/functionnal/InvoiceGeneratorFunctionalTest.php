...
/**
 * \file    test/phpunit/InvoiceGeneratorFunctionalTest.php
...
/**
 * Class InvoiceGeneratorFunctionalTest
 *
 ...
 *
 * @package Testinvoicegenerator
 */
class InvoiceGeneratorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 136001; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoiceGenerator')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoiceGenerator')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoicegenerator/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoicegenerator/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoicegenerator/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoicegenerator/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicegeneratorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoiceGenerator_InvoiceGeneratorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoiceGenerator_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
